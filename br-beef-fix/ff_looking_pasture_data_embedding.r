...
PATH_SPATIAL_METRICS <- '~/documents/data/annual_metrics/beef_annual_br_muni_v5.parquet'
...
PATH_OUTPUT <- '~/documents/data/annual_metrics/beef_{year}_post_embedding_quants_v5.parquet'
