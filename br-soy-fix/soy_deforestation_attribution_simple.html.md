...
ggplot(
  ...
  ylim(c(0, 1100)) +
  labs(
    title = "Soy Deforestation: Comparing 5 year sum",
    y = "Deforestation (kha)",
    x = "Year",
    color = NULL
  ) +
...
::: {.cell-output-display}
![](soy_deforestation_attribution_simple_files/figure-html/country-annual-comparison-1.png){width=864}
:::
...
::: {.cell-output-display}
![](soy_deforestation_attribution_simple_files/figure-html/country-annual-comparison-2.png){width=864}
:::
:::
...
::: {.cell-output-display}
![](soy_deforestation_attribution_simple_files/figure-html/country-percentage-diff-1.png){width=960}
:::
...
::: {.cell-output-display}
![](soy_deforestation_attribution_simple_files/figure-html/country-percentage-diff-2.png){width=960}
:::
...
::: {.cell-output-display}
![](soy_deforestation_attribution_simple_files/figure-html/country-percentage-diff-3.png){width=960}
:::
:::
