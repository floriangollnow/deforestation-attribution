...
```{r}
#| label: country-annual-comparison-cattle_2
#| fig-width: 9
#| fig-height: 6
ggplot(
  beef_br |>
...
```{r}
#| label: country-annual-comparison-cattle_3
#| fig-width: 9
#| fig-height: 6
ggplot(
  beef_br |>
...
```{r}
#| label: state-facet-geo-cattle-no-5ysum
#| fig-width: 11
#| fig-height: 8
ggplot(
  beef_states |>
